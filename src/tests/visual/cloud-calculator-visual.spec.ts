...
test.describe('Cloud Calculator Visual Tests', () => {
    ...
    test('Visual test for "Add to this estimate" pop-up', async ({ calculatorPage }) => {
        ...
        await expect(calculatorPage.getPage()).toHaveScreenshot('add-estimate-popup.png', { maxDiffPixels: 100 });
    });
    ...
    test('Visual test for "Compute Engine" screen', async ({ calculatorPage }) => {
        ...
        await expect(calculatorPage.getPage()).toHaveScreenshot('compute-engine-screen.png', { maxDiffPixels: 100 });
    });
    ...
    test('Visual test for cost in header', async ({ calculatorPage }) => {
        ...
        await expect(calculatorPage.getPage()).toHaveScreenshot('cost-in-header.png', { maxDiffPixels: 100 });
    });
});